...
class UEditorCommand(object):
    ...
    def render_ajax_command(self):
        ...
        """ % {"ajax_url": self.ajax_url, "ajax_success": self.onExecuteAjaxCommand("success"), "ajax_error": self.onExecuteAjaxCommand("error")}
    ...
    def render(self, editorID):
        ...
        """ % {"registerCommand": self.render_command(), "uiName": self.uiName, "uiObject": self.render_ui(editorID), "index": self.index, "editor": editorID}
...
class UEditorButtonCommand(UEditorCommand):
    ...
    def render_ui(self, editorID):
        ...
        return """
            ...
            return btn
        """ % {"icon": urljoin(USettings.gSettings.MEDIA_URL, self.icon), "onclick": self.onClick(), "title": self.title}
...
class UEditorComboCommand(UEditorCommand):
    ...
    def render_ui(self, editorID):
        ...
        return combox;
        """ % {"title": self.title, "items": str(self.get_items()), "onselect": self.onSelect(), "initValue": self.initValue}
