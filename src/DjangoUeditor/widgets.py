...
class UEditorWidget(forms.Textarea):
    def __init__(self, attrs=None):
        ...
        self.upload_settings.update({"imagePathFormat": imagePath, "filePathFormat": filePath})
        # 保存
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        uSettings["settings"].update({"serverUrl": "/ueditor/controller/?%s" % urlencode(self._upload_settings)})
        # 生成事件侦听
